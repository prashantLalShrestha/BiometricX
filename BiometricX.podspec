Pod::Spec.new do |spec|
  spec.name = "BiometricX"
  spec.version = "1.0.0"
  spec.summary = "BiometricX is just a simple Biometric Authentication Utility Module"

  spec.description = <<-DESC
  This module contains the tab bar controller with a circular button at center
                   DESC

  spec.homepage = "https://github.com/prashantLalShrestha/BiometricX"
  ...
  # spec.source = { :git => '' }
  spec.source = { 
    :git => "https://github.com/prashantLalShrestha/BiometricX.git", :tag => spec.version.to_s
  }
